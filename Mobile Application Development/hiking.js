...
item.addEventListener('touchend', (e) => {
    colsone.log(e.currentTarget.children[0]);
...
function buildList() {
    hikeList.forEach(hike => {
        listElement.appendChild(markUp(hike))
    });
}

listElement.appendChild(markUp(hikeList[0]));
buildList();
//listElement.appendChild(buildHikeDetails(hikeList[0]));
